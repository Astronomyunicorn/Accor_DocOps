...
[arabic]
. *Developer* writes documentation in Markdown
. *Developer* pushes to GitHub repository
. *GitHub Actions* (CI/CD) validates and builds site
. *GitHub Actions* deploys to GitHub Pages
. *GitHub Pages* serves static site
. *Users* (Developers, L1 Support, Managers) read documentation via
browser
...
* *Public Access:* Documentation site is public (or org-only based on
repo settings)
* *Sensitive Content:* Marked with `sensitivity:confidential` or
`sensitivity:restricted` tags

=== Next Level

For detailed component view, see link:./containers.md[Container
Diagram].
