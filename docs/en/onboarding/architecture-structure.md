...
Accor DocOps uses a **practical, adapted architecture documentation structure** based on industry best practices (Arc42, ADRs, C4 diagrams) but simplified for our use case.
